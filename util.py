...
# str(value) — текст кнопки.
# callback_data=str(key) — данные, которые будут отправлены обратно в бот, когда кнопка будет нажата.
# update -  Объект, представляющий обновление, полученное от Telegram (например, сообщение, нажатие кнопки и т. д.).
# context: Контекст, который содержит информацию о текущем состоянии бота и данные, связанные с обновлением.
